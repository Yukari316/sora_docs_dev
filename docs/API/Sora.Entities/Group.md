...
| [GetGroupCmdSeries](Group/GetGroupCmdSeries.md)() | 获取群组指令使能列表 |
...
| [TryDisableCommandSeries](Group/TryDisableCommandSeries.md)(…) | 禁用群组中的指令组 |
| [TryEnableCommandSeries](Group/TryEnableCommandSeries.md)(…) | 启用群组中的指令组 |
